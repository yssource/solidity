...
private:
	...
	/// This is one for any type other than a dynamically sized calldata array or
	/// external function types (unless we are encoding from anything else than the stack),
	/// for which it is two.
